...
Provide frontend UI elements for uploading, selecting, and querying API documentation documents through the API Doc pipeline, including strategy selection, backend routing, and response display.
