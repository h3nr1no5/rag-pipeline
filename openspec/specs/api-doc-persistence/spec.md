...
Persist extracted API documentation data (domain objects, chunk graph, and embedding vectors) to SQLite so indexes survive server restarts and can be rebuilt at startup without calling the embedder model.
