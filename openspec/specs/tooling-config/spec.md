...
Define the tooling configuration standards for the project, ensuring consistent linting, type-checking, dependency management, and package structure across the codebase.
