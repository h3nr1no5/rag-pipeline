# API Docs Reasoning Hint

## Purpose

Expose the DSPy ChainOfThought reasoning trace (rationale) as a `reasoning_hint` field in the API docs query response, providing users with visibility into how answers are derived.
