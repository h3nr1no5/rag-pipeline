...
Define how the chat page's RAG backend selection behaves when documents processed with the API Documentation engine type are selected, including enabling/disabling of backend checkboxes and query routing behavior.
