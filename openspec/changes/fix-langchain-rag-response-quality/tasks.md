...
- [/] 4.3 Manually test a query that previously returned "I don't have enough information" to confirm fix (cannot run full integration without a running backend with documents; requires model downloads)
