...
<proven_patterns ref=".opencode/docs/agents/research-backed-prompt-design.md" />
<quality_standards>
    <research_based>See .opencode/docs/agents/research-backed-prompt-design.md for full research reference</research_based>
...
<references>
  ...
  <research_patterns ref=".opencode/docs/agents/research-backed-prompt-design.md">
